...
This project builds on an 8,000-image dataset of visual styles with LLM-derived emotional profiles, mapped into 8 emotion clusters. It aims to predict cluster membership for new images and identify the visual features driving emotional responses.
