...
# Roadmap
	...
	3. Human baseline survey
	4. Baseline CNN
	5. Style-aware k-fold validation
	6. Optuna hyperparameter tuning
	7. Transfer learning with MobileNetV3
	8. Results, challenges, and next steps
...
| Metric     | Score       |        |
| :--------- | :---------- | -----: |
| 5-fold CV  | Accuracy    | 0.3486 |
| 5-fold CV  | Macro F1    | 0.3045 |
...
| Metric     | Score       |        |
| :--------- | :---------- | -----: |
| 5-fold CV  | Accuracy    | 0.4576 |
| 5-fold CV  | Macro F1    | 0.4167 |
...
| Model / baseline              | Accuracy | F1 Weighted |
| :---------------------------- | :------- | :---------- |
| Human survey baseline, N=5    | 0.3375   | 0.3868      |
| Baseline CNN                  | 0.3998   | 0.3748      |
| CNN + style-aware k-fold      | 0.4237   | 0.4118      |
| Optuna-tuned CNN              | 0.3493   | 0.3593      |
| MobileNetV3 transfer learning | 0.5092   | 0.4920      |
